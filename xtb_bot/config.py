...
_GLOBAL_DEFAULTS: dict[str, Any] = {
    ...
    "protective_exit_arm_min_profit_pips": 3.0,
    ...
    "protective_index_trend_reversal_grace_sec": 45.0,
    "protective_index_trend_reversal_grace_max_adverse_spread_ratio": 2.5,
    "protective_fresh_reversal_grace_sec": 30.0,
...
_MOMENTUM_DEFAULTS: dict[str, Any] = {
    "fast_window": 8,
    "slow_window": 21,
...
_TREND_FOLLOWING_DEFAULTS: dict[str, Any] = {
    "fast_ema_window": 13,
    "slow_ema_window": 55,
...
_DONCHIAN_DEFAULTS: dict[str, Any] = {
    "donchian_window": 20,
...
_MEAN_BREAKOUT_DEFAULTS: dict[str, Any] = {
    "mb_zscore_window": 50,
...
_MEAN_REVERSION_BB_DEFAULTS: dict[str, Any] = {
...
_INDEX_HYBRID_DEFAULTS: dict[str, Any] = {
    ...
    "index_min_breakout_distance_ratio": 0.0002,
    ...
    "index_confidence_threshold_cap_trend": 0.72,
...
_CRYPTO_TREND_DEFAULTS: dict[str, Any] = {
...
_MULTI_STRATEGY_DEFAULTS: dict[str, Any] = {
...
DEFAULT_STRATEGY_PARAMS: dict[str, Any] = {
    ...
    **_G1_DEFAULTS,
    **_G2_DEFAULTS,
    **_TREND_FOLLOWING_DEFAULTS,
    **_DONCHIAN_DEFAULTS,
    **_MEAN_BREAKOUT_DEFAULTS,
    **_MEAN_REVERSION_BB_DEFAULTS,
    **_INDEX_HYBRID_DEFAULTS,
    **_CRYPTO_TREND_DEFAULTS,
    **_MULTI_STRATEGY_DEFAULTS,
}
